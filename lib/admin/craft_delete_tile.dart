...
class craft_delete_tile extends StatefulWidget {
  const craft_delete_tile({Key? key}) : super(key: key);

  @override
  State<craft_delete_tile> createState() => _craft_delete_tileState();
}

class _craft_delete_tileState extends State<craft_delete_tile> {
