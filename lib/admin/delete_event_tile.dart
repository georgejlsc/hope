...
class delete_event_tile extends StatefulWidget {
  const delete_event_tile({Key? key}) : super(key: key);

  @override
  State<delete_event_tile> createState() => _delete_event_tileState();
}

class _delete_event_tileState extends State<delete_event_tile> {
